...
namespace GKNData
{
    public partial class wzlBlockEd : Form
    {
        ...
        private void ListFiles()
        {
            ...
            foreach (netFteo.BaseClasess.TFile file in ITEM.KPTXmlBodyList)
            {
        ...
        private void SaveXMLfromSelectedNode()
        {
            ...
            {
                netFteo.BaseClasess.TFile xmlFile = ITEM.KPTXmlBodyList.GetFile((int)listView1.SelectedItems[0].Tag);
