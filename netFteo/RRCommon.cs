...
public enum dParcelsv01_enum
   ...
   public class TMyDocument
   {
    ...
    public enum EncumbranceVersion
    {
        v01 = 1 ,
        v201 =201,
        v03 = 03
   ...
   public class TMyEncumbrance
   {
       ...
       public EncumbranceVersion EncumbranceVersion; 
       ...
       public TMyEncumbrance()
       {
           ...
           EncumbranceVersion = EncumbranceVersion.v03; //Default, last version of distionary
       }
       public string Type
       {
            get {
                /*
                if (EncumbranceVersion == EncumbranceVersion.v201)
                    return dEncumbrancesv201.ItemToName(this.FType);
                else
                    */
                    return this.FType; // not translate
            }
